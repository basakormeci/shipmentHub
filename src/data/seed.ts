...
export const SEED_NODES: StockNode[] = [
  { id: 1, name: 'İstanbul Ana Depo', code: 'IST001', provinceId: 1 },
  { id: 2, name: 'İstanbul Anadolu', code: 'IST002', provinceId: 1 },
  { id: 3, name: 'Ankara Merkez', code: 'ANK001', provinceId: 2 },
  { id: 4, name: 'Ankara Ostim', code: 'ANK002', provinceId: 2 },
  { id: 5, name: 'İzmir Depo', code: 'IZM001', provinceId: 3 },
  { id: 6, name: 'Bursa Depo', code: 'BRS001', provinceId: 4 },
  { id: 7, name: 'Antalya Merkez', code: 'ANT001', provinceId: 5 },
  { id: 8, name: 'Adana Depo', code: 'ADA001', provinceId: 6 },
  { id: 9, name: 'Gaziantep Merkez', code: 'GAZ001', provinceId: 8 },
  { id: 10, name: 'Konya Depo', code: 'KNY001', provinceId: 7 },
  { id: 11, name: 'Kayseri Depo', code: 'KYS001', provinceId: 12 },
  { id: 12, name: 'Trabzon Merkez', code: 'TRB001', provinceId: 9 },
  { id: 13, name: 'Diyarbakır Depo', code: 'DYB001', provinceId: 11 },
